...
add_action( 'wp_enqueue_scripts', function () {
	wp_enqueue_style( 'selzy_form_css', WPSELZY_PLUGIN_URL . '/assets/css/selzy.css', [], '1.0.0', 'all' );
	wp_enqueue_script( 'selzy_form_js', WPSELZY_PLUGIN_URL . '/assets/js/selzy.js', [], '1.0.0', 'all' );
	wp_localize_script( 'selzy_form_js', 'SELZY_AJAX',
		array(
